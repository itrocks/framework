...
$.getScript(path + 'vendor/jquery/jquery-mousewheel/jquery.mousewheel.min.js');
...
$.getScript(path + 'itrocks/framework/js/jquery.autoheight.js');
...
$.getScript(path + 'itrocks/framework/js/jquery.fixedheaders.js');
