 ...
 *
 * TODO should add @override civility @impacts name to Person_Having_Name
 * TODO should add #[Override('civility', new Setter('setNameComponent'))] to Person_Having_Name
 */
