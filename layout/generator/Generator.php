...
use ITRocks\Framework\Layout\Generator\Cut_Iterations;
...
class Generator
{
	...
	public function generate(object $object) : Structure
	{
		...
		(new Cut_Iterations($this->structure))->run();
		(new Automatic_Line_Feed($this->structure))->setOutput($this->output)->run();
